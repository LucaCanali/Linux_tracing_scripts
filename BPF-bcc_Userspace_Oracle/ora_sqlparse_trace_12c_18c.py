...
address_list = BPF.get_user_functions_and_addresses(oracle_executable, "^opiprs$")

# workaround for Oracle 12c and higher
# need to attach the address of the probe + 2
paddr = address_list[0][1] + 2 

b.attach_uprobe(name=oracle_executable, addr=paddr, fn_name="trace_opiprs")
...
# This is a test with a possible patch to bcc to add an offset parameter to attach_uprobe 
# b.attach_uprobe(name=oracle_executable, sym="opiprs", fn_name="trace_opiprs", offset=2)
